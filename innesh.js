...
var huntkanal = "1128066102962962525";
...
innesh.on("message",message=>{if(message.author.id == ownerid){if(message.content == "dm bax"){db.set("huntbot","açık"); message.channel.send("");};};});  
